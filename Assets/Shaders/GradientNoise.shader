Shader "Unlit/Zero2Shaders/GradientNoise"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                return frac(sin(dot(v.xy, float2(12.9898, 78.233)))* 42758.5453123);
            }
            ...
            {
                //use noise as color
                // return graidentNoise(i.uv) * 0.5f + 0.5f;
                ...
                {
                    n += graidentNoise(v * fq) * amplitude;
                    fq *= 2.0f;
                    amplitude *= 0.5f;
                }
